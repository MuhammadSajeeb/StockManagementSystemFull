    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                ...
                <asp:TextBox runat="server" ID="txtUnitPrice" CssClass="form-control" TextMode="Number" Font-Bold="true" Font-Size="Medium" Style="text-align: center" AutoPostBack="true" OnTextChanged="txtUnitPrice_TextChanged" />
            ...
            <div class="col-md-2">
                ...
                <asp:TextBox runat="server" ID="txtMrp" CssClass="form-control" TextMode="Number" Font-Bold="true" Font-Size="Medium" Style="text-align: center" />
            </div>
        </div>
        <div class="form-group">
